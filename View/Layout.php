        ...
        <div class="global">
            ...
            <div class="wrapper">
                <div class="container" style="height: 100%;">
                    <div class="row" style="">
                        <!-- TERMINAL -->
                        <div class="col-sm-12 col-xs-12 col-md-push-2 col-md-7">
                            <div class="consola-entries"> <?= $contenu ?> </div>
                        </div>
                        <div class="col-md-3 col-md-push-2 hidden-sm hidden-xs">
                            <div class="consola-sidebar-menu">
                                <ul class="consola-options" role="menu">
                                    <li><a href="user"><span class="fa fa-fw fa-user fa-2x"></span> Utilisateur</a></li>
